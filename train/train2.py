...
if __name__ == "__main__":
    ...
    # training parameters
    parser.add_argument('--epochs', type = int, default = 41, help = 'number of epochs of training') # change if fine-tune
    ...
    parser.add_argument('--gan_mode', type = str, default = 'WGAN', help = 'type of GAN: [no | LSGAN | WGAN | WGANGP], WGAN is recommended')
    # loss balancing parameters
    parser.add_argument('--lambda_l1', type = float, default = 10, help = 'coefficient for L1 Loss')
    parser.add_argument('--lambda_percep', type = float, default = 10, help = 'coefficient for Perceptual Loss')
    parser.add_argument('--lambda_gan', type = float, default = 1, help = 'coefficient for GAN Loss')
    parser.add_argument('--lambda_flow', type = float, default = 0.5, help = 'coefficient for Flow Loss')
    parser.add_argument('--lambda_flow_short', type = float, default = 3, help = 'coefficient for Perceptual Loss')
    parser.add_argument('--lambda_flow_long', type = float, default = 5, help = 'coefficient for Perceptual Loss')
