...
def define_imglist(path):
    ...
    wholepathlist = utils.get_files(path)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--load_name', type = str, default = '', help = 'load the trained pth model with certain epoch')
    ...
    imglist = define_imglist(opt.videopath)
    print(imglist)
