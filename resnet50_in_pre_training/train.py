...
if __name__ == "__main__":
    ...
    parser.add_argument('--cudnn_benchmark', type = bool, default = False, help = 'if input data structure is unchanged, set it as True')
    # Training setting
    parser.add_argument('--epochs', type = int, default = 150, help = 'number of epochs of training')
    parser.add_argument('--batch_size', type = int, default = 256, help = 'size of the batches')
    parser.add_argument('--lr', type = float, default = 0.1, help = 'SGD: initial learning rate')
    parser.add_argument('--momentum', type = float, default = 0.9, help = 'SGD: momentum')
    parser.add_argument('--weight_decay', type = float, default = 1e-5, help = 'SGD: weight-decay, L2 normalization')
    parser.add_argument('--lr_decrease_epoch', type = int, default = 1, help = 'lr decrease at certain epoch and its multiple')
    parser.add_argument('--lr_decrease_factor', type = float, default = 0.98, help = 'lr decrease factor, for classification default 0.1')
    ...
    parser.add_argument('--jpeg_quality', type = int, default = 10, help = 'parameter of jpeg_quality')
    parser.add_argument('--noise_var', type = int, default = 30, help = 'parameter of noise_var')
    # Network setting
    parser.add_argument('--type', type = str, \
        default = 'resnet50', help = 'resnet type')
