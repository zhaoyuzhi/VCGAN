...
python WarpError_by_txt_DAVIS.py --basepath ${basepath1}
python WarpError_by_txt_DAVIS.py --basepath ${basepath2}
python WarpError_by_txt_DAVIS.py --basepath ${basepath3}
python WarpError_by_txt_DAVIS.py --basepath ${basepath4}
python WarpError_by_txt_DAVIS.py --basepath ${basepath5}
python WarpError_by_txt_DAVIS.py --basepath ${basepath6}
python WarpError_by_txt_DAVIS.py --basepath ${basepath7}
python WarpError_by_txt_DAVIS.py --basepath ${basepath8}
python WarpError_by_txt_DAVIS.py --basepath ${basepath9}
python WarpError_by_txt_DAVIS.py --basepath ${basepath10}
python WarpError_by_txt_DAVIS.py --basepath ${basepath11}
python WarpError_by_txt_DAVIS.py --basepath ${basepath12}
python WarpError_by_txt_DAVIS.py --basepath ${basepath13}
python WarpError_by_txt_DAVIS.py --basepath ${basepath14}
python WarpError_by_txt_DAVIS.py --basepath ${basepath15}
python WarpError_by_txt_DAVIS.py --basepath ${basepath16}
python WarpError_by_txt_DAVIS.py --basepath ${basepath17}
