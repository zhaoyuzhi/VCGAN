...
python NRMSE_PSNR_SSIM_bylistname_align_videvo.py --refpath ${refpath} --basepath ${basepath1}
python NRMSE_PSNR_SSIM_bylistname_align_videvo.py --refpath ${refpath} --basepath ${basepath2}
python NRMSE_PSNR_SSIM_bylistname_align_videvo.py --refpath ${refpath} --basepath ${basepath3}
python NRMSE_PSNR_SSIM_bylistname_align_videvo.py --refpath ${refpath} --basepath ${basepath4}
python NRMSE_PSNR_SSIM_bylistname_align_videvo.py --refpath ${refpath} --basepath ${basepath5}
python NRMSE_PSNR_SSIM_bylistname_align_videvo.py --refpath ${refpath} --basepath ${basepath6}
python NRMSE_PSNR_SSIM_bylistname_align_videvo.py --refpath ${refpath} --basepath ${basepath7}
python NRMSE_PSNR_SSIM_bylistname_align_videvo.py --refpath ${refpath} --basepath ${basepath8}
python NRMSE_PSNR_SSIM_bylistname_align_videvo.py --refpath ${refpath} --basepath ${basepath9}
python NRMSE_PSNR_SSIM_bylistname_align_videvo.py --refpath ${refpath} --basepath ${basepath10}
python NRMSE_PSNR_SSIM_bylistname_align_videvo.py --refpath ${refpath} --basepath ${basepath11}
python NRMSE_PSNR_SSIM_bylistname_align_videvo.py --refpath ${refpath} --basepath ${basepath12}
python NRMSE_PSNR_SSIM_bylistname_align_videvo.py --refpath ${refpath} --basepath ${basepath13}
python NRMSE_PSNR_SSIM_bylistname_align_videvo.py --refpath ${refpath} --basepath ${basepath14}
python NRMSE_PSNR_SSIM_bylistname_align_videvo.py --refpath ${refpath} --basepath ${basepath15}
python NRMSE_PSNR_SSIM_bylistname_align_videvo.py --refpath ${refpath} --basepath ${basepath16}
python NRMSE_PSNR_SSIM_bylistname_align_videvo.py --refpath ${refpath} --basepath ${basepath17}
